...
public final class Constants {
    ...
    public static final int OPERATOR_MANUAL_TURRET_AXIS = 0;
    public static final int DRIVER_BUTTON_INDEX_POSITION_CONTROL = 7;
	public static final int DRIVER_BUTTON_INDEX_ROTATION_CONTROL = 8;
	public static final int OPERATOR_SET_X_ALIGN_BUTTON = 5;
