...
public class Shooter extends SubsystemBase {
  ...
  public void periodic() {
    SmartDashboard.putData("Linear Act", linearAct);
  ...
  public double getVelocity(){
    ...
    double selSenVel = talonFX.getSelectedSensorVelocity(0); /* position units per 100ms */
    //double pos_Rotations = (double) selSenPos / kUnitsPerRevolution;
		double vel_RotPerSec = selSenVel / kUnitsPerRevolution * 10; /* scale per100ms to perSecond */
